"""
Django settings for wdvo_42059 project.
...
WSGI_APPLICATION = 'wdvo_42059.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wdvo_42059 API",
    "DESCRIPTION": "API documentation for wdvo_42059 App",
    "VERSION": "v1",
}
